        ...
        <div className="row mx-0 pt-5 px-sm-3 px-lg-5 mt-4">
            ...
            <div className="col-lg-3 col-md-6 mb-5">
                ...
                <div className="d-flex justify-content-start">
                  {icons.map((item)=>(<a  key={item.id} className="btn btn-lg btn-outline-light btn-lg-square mr-2" href={item.link}><img className="mb-1" src={item.img} alt=""/></a>))}
                    ...
                    <a className="btn btn-lg btn-outline-light btn-lg-square" href="#"><i class="fab fa-instagram"></i></a>*/}
                </div>
            </div>
            <div className="col-lg-3 col-md-6 mb-5">
