...
function Reservation() {
  const [selectedOption, setSelectedOption] = useState("1"); // Default option value
                    ...
                    <div className="col-lg-6">
                        <div className="text-center p-5" style={{background: "rgba(51, 33, 29, .8)"}}>
                            ...
                            <form className="mb-5">
                                ...
                                <div className="form-group">
                                    <select value={selectedOption} onChange={handleChange} className="custom-select bg-transparent border-primary px-4" style={{height: '49px'}}>
